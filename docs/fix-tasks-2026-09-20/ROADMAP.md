...
| R4 | 一 | KWin dock-animation 全屏重绘 + 每帧网格 | `integrations/kwin/dock-window-animation/*` | — | B |
| R5 | 一 | KWin dock-animation 析构 UAF | `integrations/kwin/dock-window-animation/*` | R4(同文件) | B |
